...
const Robot =()=>{
    return(
        <div>
            ...
            <div className='flex justify-center items-center  w-[80%] ml-[10%] mr-[10%] '>
                <p className='text-[40px] text-[#FFFF]'>3800+</p> 
                <p className='text-[20px] text-[#33BBCF] p-4'> USER ACTIVE </p>
                <p className='text-[20px] text-[#33BBCF] p-4'> | </p>
                <p className='text-[40px] text-[#FFFF] '>230+</p> 
                <p className='text-[20px] text-[#33BBCF] p-4'> TRUSTED BY COMPANY </p>
                <p className='text-[20px] text-[#33BBCF] p-4'> | </p>
                <p className='text-[40px] text-[#FFFF] '>$230M+</p> 
                <p className='text-[20px] text-[#33BBCF] p-4'> TRANSACTION </p>
                <p className='text-[20px] text-[#33BBCF] p-4 '> | </p>
