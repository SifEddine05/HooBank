...
const text = ({title,text,btnText}) => {
    ...
    <button className="rounded-lg bg-[#33BBCF]  mt-4 md:mt-8 sm:mt-6 lg:mt-10  text-[8px] sm:text-[10px] md:text-[14px] lg:text-[18px]  w-[40px] sm:w-[80px] md:w-[120px] lg:w-[160px] h-[28px] sm:h-[38px] md:h-[48px] lg:h-[58px] drop-shadow-xl hover:text-white" >{btnText}</button>
</div>
 );
}
